...
<template>
    <div class="card">
        ...
        <div>
            ...
            <p v-if="patent.abstractCh.length > 105">
                <b>摘要</b>：<span v-html="patent.abstractCh.substring(0, 190) + '...'"></span>
            </p>
            <p v-else class="line-limit-length">
                <b>摘要</b>：<span v-html="patent.abstractCh"></span>
            </p>
        </div>
        <Modal v-model="modal">
        ...
        methods: {
            ...
            ok() {
                ...
                if (this.selectedNodes.length > 0) {
                    ...
                    this.patentBriefDO.patentAbstract = this.patent.abstractCh;
